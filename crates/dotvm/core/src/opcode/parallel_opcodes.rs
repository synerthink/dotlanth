...
impl ParallelOpcode {
    ...
    pub fn scaling_factor(&self) -> ScalingFactor {
        match self {
            ...
            ParallelOpcode::Map | ParallelOpcode::Filter | ParallelOpcode::ParallelAdd | ParallelOpcode::ParallelMul | ParallelOpcode::ParallelLoad | ParallelOpcode::ParallelStore => {
                ScalingFactor::Linear
            }

            // Good scaling operations
            ParallelOpcode::Reduce | ParallelOpcode::Scan | ParallelOpcode::ParallelDot | ParallelOpcode::ParallelSum | ParallelOpcode::ParallelSearch => ScalingFactor::Logarithmic,

            // Limited scaling operations
            ParallelOpcode::Sort | ParallelOpcode::ParallelMerge | ParallelOpcode::ParallelPartition => ScalingFactor::LogLinear,

            // Synchronization overhead
            ParallelOpcode::Fork | ParallelOpcode::Join | ParallelOpcode::Barrier | ParallelOpcode::Lock | ParallelOpcode::Unlock => ScalingFactor::Constant,

            // Atomic operations (contention dependent)
            ParallelOpcode::AtomicAdd | ParallelOpcode::AtomicSub | ParallelOpcode::AtomicCas | ParallelOpcode::AtomicExchange => ScalingFactor::Sublinear,
    ...
    pub fn memory_pattern(&self) -> MemoryAccessPattern {
        match self {
            ParallelOpcode::ParallelLoad | ParallelOpcode::ParallelStore | ParallelOpcode::ParallelCopy => MemoryAccessPattern::Sequential,

            ParallelOpcode::Map | ParallelOpcode::Filter | ParallelOpcode::ParallelAdd | ParallelOpcode::ParallelMul => MemoryAccessPattern::Strided,

            ParallelOpcode::ParallelSearch | ParallelOpcode::ParallelShuffle | ParallelOpcode::WorkSteal => MemoryAccessPattern::Random,

            ParallelOpcode::Reduce | ParallelOpcode::Scan | ParallelOpcode::Sort => MemoryAccessPattern::Gather,
